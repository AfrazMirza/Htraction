...
const Search = () => {
  ...
  return (
   <View style={styles.mainContainer}>
    ...
    <IdeaHubInputs title="Search and select mentors and investors from whom you want to get your idea evaluated" input="Select and search users to add in group" />
    <View style={styles.infoContainer}>
        <Text style={styles.infoText}>Select mentors and investors from the recommended list below to share this idea for evaluation.</Text>
        <Profile/>
        <Profile/>
        <Profile/>
        <Profile/>
