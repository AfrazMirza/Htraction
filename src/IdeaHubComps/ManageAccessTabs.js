...
import CompaniesAbout from '../CompanyComp.js/CompaniesAbout'
...
const ManageAccessTabs = () => {
  ...
  <TouchableOpacity onPress={()=> setSelectedTab("Collaborators")} >
    <Text style={[styles.txt, selectedTab === "Collaborators" && styles.activeTab]}>Collaborators</Text>
  </TouchableOpacity>
  <TouchableOpacity onPress={()=> setSelectedTab("Evaluators")} >
    <Text style={[styles.txt, selectedTab === "Evaluators" && styles.activeTab]}>Evaluators</Text>
  </TouchableOpacity>
